...
const PopularRecipes = () => {
    return (
        <div className='flex flex-col gap-5 w-3/4 mx-auto my-10'>
            <h3 className='text-center text-3xl font-display my-8'>Trending Recipe</h3>
            <div className='flex gap-10 font-display'>
                <img className="w-96 h-fit rounded" src="https://img.freepik.com/free-photo/curry-with-chicken-onions-indian-food-asian-cuisine_2829-4415.jpg?w=900&t=st=1683002614~exp=1683003214~hmac=17590d3489b65f5c0a602ee7d13afc009a586b0333087b76628c10719a28f44d" alt="Card image" />
            ...
            <div className='flex gap-10 font-display'>
                <img className="w-96 rounded" src="https://img.freepik.com/free-photo/traditional-indian-soup-lentils-indian-dhal-spicy-curry-bowl-spices-herbs-rustic-black-wooden-table_2829-18717.jpg?w=996&t=st=1683004817~exp=1683005417~hmac=39145c4a32f7eb6b171794b16637af60f3c5878a0c47e4e47b91b21f67a197ae" alt="Card image" />
            ...
            <div className='flex gap-10'>
                <img className="w-96 rounded" src="https://img.freepik.com/free-photo/side-view-chicken-kebab-with-grilled-hot-green-pepper-tomato-pickled-cabbage-rice-pita_141793-4837.jpg?w=996&t=st=1683005627~exp=1683006227~hmac=be01231ca37b83349b5798ec1bb83539649ad81ded7ebac1577136654df01f60" alt="Card image" />
            ...
            <div className='flex gap-10 font-display'>
                <img className="w-96 rounded" src="https://img.freepik.com/premium-photo/mumbai-style-pav-bhaji-is-fast-food-dish-from-india-consists-thick-vegetable-curry-served-with-soft-bread-roll-served-plate_466689-2267.jpg?w=996" />
